    ...
    <div className="relative  overflow-hidden">
      ...
      <div className="relative pt-6 pb-16 sm:pb-24">
        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-indigo-600 xl:inline underline">DREAM database</span>
            </h1>
        ...
        {buttonList.map((singleButton) => (
          <li key={singleButton.name} className="col-span-1 flex shadow-sm rounded-md">
            ...
            <div className="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-gray-800  rounded-r-md truncate">
              <div className="flex-1 px-4 py-2 text-sm truncate">
                <a href={singleButton.href} className="text-gray-200  font-medium text-lg">
                  {singleButton.name}
                </a>
              </div>
