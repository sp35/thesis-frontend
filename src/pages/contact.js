          ...
          <div className="divide-y-2 divide-gray-200">
            <div className="lg:grid lg:grid-cols-3 lg:gap-8">
              ...
              <div className="mt-8 grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-12 lg:mt-0 lg:col-span-2">
                <div>
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Dr. Rita Sharma</h3>
                ...
                <div>
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Siddhant Gambhir</h3>
                  <dl className="mt-2 text-base text-gray-500">
                    <div>
                      <dt className="sr-only">Email</dt>
                ...
                <div>
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Person A</h3>
                  <dl className="mt-2 text-base text-gray-500">
                    <div>
                      <dt className="sr-only">Email</dt>
                ...
                <div>
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Person B</h3>
                  <dl className="mt-2 text-base text-gray-500">
                    <div>
                      <dt className="sr-only">Email</dt>
                      <dd>support@example.com</dd>
